    ...
    for file in files:
        if file.endswith(".md"):
            ...
            with open(input_file, 'r') as f:
                input_str = f.read()
            # Convert soft breaks to hard breaks while ensuring there are always exactly 2 spaces at the end of each line and removing ">" character at the start of a line
